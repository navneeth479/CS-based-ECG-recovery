...
recon_image, library = recon.backproject(sino_filtered, grid_phantom.get_size()[0], grid_phantom.get_size()[1], grid_phantom.get_spacing())
utils.show(recon_image, "Filtered back projected Image (FBP) ")
